        ...
        <div class="col-md-10"><br>
                ...
                <tbody>
                    ...
                    ?>
                        <div class="form-group">
                            ...
                            <td><?php echo $r[1]; ?></td>
                            <td><?php 
                            if($r['nivel']==1){echo 'Admintrador';}
                            else{echo 'Vendedor';}
                             ?></td>
                            <td><a href='usuarioModificaIn.php?cod=<?php echo $r[5];?>' class="btn btn-warning bi bi-pencil-square"> Activo</a></td>    
                            <td><a href='usuarioEliminaIn.php?cod=<?php echo $r[5];?>' class="btn btn-danger bi bi-trash"> Eliminar</a></td>    
                        <?php
                        }
                    ?>
                            </tr>
            ...
            <table>
                <tr>
                    ...
                    <td><a href="../controlador/usuarioBusquedaIn.php" class="btn btn-success bi bi-search"> Buscar Usuario</a></td>
